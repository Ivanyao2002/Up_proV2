...
export function FranchiseVehicleDetailPage({
  ...
  const deleteVehicle = useFranchiseVehicleDelete();
  ...
  return (
    <div className="animate-fade-up">
      <div className="page-sticky-header">
        <PageHeader
          title={title}
          breadcrumb={["Franchise", "Flotte", "Véhicules", title]}
          actions={
            <div className="flex flex-wrap items-center gap-2">
              <VehicleApprovalPill status={vehicle.approval_status} />
              {canApprove && (
                <Button
                  onClick={() => approve.mutate({ id: vehicleId })}
              ...
              {canReject && (
                <Button
                  variant="secondary"
                  onClick={() => reject.mutate({ id: vehicleId })}
          ...
          <div className="rounded-card border border-border bg-surface p-5 shadow-card text-sm">
            ...
            {vehicle.driver_id ? (
              <div className="mt-3 space-y-3">
                ...
                <Link
                  href={`/franchise/fleet/drivers/${vehicle.driver_id}`}
      ...
      <ConfirmModal
        ...
        onConfirm={() => {
          deleteVehicle.mutate(vehicleId, {
            onSuccess: () => router.push("/franchise/fleet/vehicles"),
          });
