...
export function mapFranchiseDashboard(
  ...
  return {
    ...
    trips_completed_today: asNumber(d.trips_completed_today ?? d.completedToday),
    trips_in_progress_today: asNumber(d.trips_in_progress_today ?? d.inProgressToday),
    trips_cancelled_today: asNumber(d.trips_cancelled_today ?? d.cancelledToday),
